...
if (EMBEDDING_TYPE == "tss") {
  embeddings_path <- "../../../embeddings/embeddings_enformer_tss_1024.npy"
  ...
  embeddings_path <- "../../../embeddings/embeddings_enformer_gencode.v49.pc_transcripts_1024.npy"
...
for(input_file in input_files){
  ...
  # Step 5. Save results
  output_file <- paste0("../results/", EMBEDDING_TYPE, "_results_cv.csv")
