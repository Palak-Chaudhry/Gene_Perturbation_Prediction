...
embedding_json_file = f"../results/{EMBEDDING_TYPE}_heldout_embeddings.json"
...
embedding_csv_file = f"../results/{EMBEDDING_TYPE}_heldout_embeddings.csv"
...
csv_file = f"../results/{EMBEDDING_TYPE}_heldout_results.csv"
json_file = f"../results/{EMBEDDING_TYPE}_heldout_results.json"
