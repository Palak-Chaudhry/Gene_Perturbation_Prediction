...
# Save to JSON files
with open('../cluster_assignments/elasticnet_gencode_2d_k4.json', 'w') as f:
    json.dump(gencode_clusters, f, indent=2)
print("Saved: ../cluster_assignments/elasticnet_gencode_2d_k4.json")

with open('../cluster_assignments/elasticnet_tss_2d_k4.json', 'w') as f:
    json.dump(tss_clusters, f, indent=2)
print("Saved: ../cluster_assignments/elasticnet_tss_2d_k4.json")
...
plt.tight_layout()
plt.savefig('../figures/32dim/tss_clustering_2d.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('../figures/32dim/gencode_clustering_2d.png', dpi=300, bbox_inches='tight')
plt.show()
...
# Save to JSON files
with open('../cluster_assignments/elasticnet_gencode_3d_k4.json', 'w') as f:
    json.dump(gencode_clusters, f, indent=2)
print("Saved: ../cluster_assignments/elasticnet_gencode_3d_k4.json")

with open('../cluster_assignments/elasticnet_tss_3d_k4.json', 'w') as f:
    json.dump(tss_clusters, f, indent=2)
print("Saved: ../cluster_assignments/elasticnet_tss_3d_k4.json")
...
plt.suptitle(f'ElasticNet - TSS - Clustering Results (k={optimal_k})', fontsize=16, fontweight='bold')
plt.tight_layout()
plt.savefig('../figures/32dim/tss_clustering_3d.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.suptitle(f'ElasticNet - Gencode - Clustering Results (k={optimal_k})', fontsize=16, fontweight='bold')
plt.tight_layout()
plt.savefig('../figures/32dim/gencode_clustering_3d.png', dpi=300, bbox_inches='tight')
plt.show()
...
fig.write_html('../figures/interactive/elasticnet_gencode_kmeans_3d_umap.html')
print("Saved: ../figures/interactive/elasticnet_gencode_kmeans_3d_umap.html")
...
fig = px.scatter_3d(df_plot_gencode_gmm, 
                    ...
                    color_continuous_scale='Viridis')
fig.update_traces(marker=dict(size=5))
fig.write_html('../figures/interactive/elasticnet_gencode_gmm_3d_umap.html')
print("Saved: ../figures/interactive/elasticnet_gencode_gmm_3d_umap.html")
...
fig = px.scatter_3d(df_plot_tss_kmeans, 
                    ...
                    color_continuous_scale='Viridis')
fig.update_traces(marker=dict(size=5))
fig.write_html('../figures/interactive/elasticnet_tss_kmeans_3d_umap.html')
print("Saved: ../figures/interactive/elasticnet_tss_kmeans_3d_umap.html")
...
fig = px.scatter_3d(df_plot_tss_gmm, 
                    ...
                    color_continuous_scale='Viridis')
fig.update_traces(marker=dict(size=5))
fig.write_html('../figures/interactive/elasticnet_tss_gmm_3d_umap.html')
print("Saved: ../figures/interactive/elasticnet_tss_gmm_3d_umap.html")
