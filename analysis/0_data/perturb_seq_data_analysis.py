...
X_target_zscore = X_target_mean / (X_target_std + 1e-8)  # add epsilon to avoid division by zero
...
# X_target_zscore.to_csv("../../perturb_seq_data/fibroblast_CRISPRa_mean_pop_zscore.csv")
