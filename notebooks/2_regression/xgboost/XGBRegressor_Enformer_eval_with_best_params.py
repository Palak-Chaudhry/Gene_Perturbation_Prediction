...
param_file = f"enformer_{EMBEDDING_TYPE}_xgboost_results_" + input_file.split("/")[-1] + ".csv"
...
csv_file = f"enformer_{EMBEDDING_TYPE}_xgboost_eval_with_best_params_" + input_file.split("/")[-1] + ".csv"
...
# Save summary
summary_file = f"enformer_{EMBEDDING_TYPE}_xgboost_eval_summary_" + input_file.split("/")[-1] + ".csv"
...
weights_file = f"enformer_{EMBEDDING_TYPE}_xgboost_feature_importance_" + input_file.split("/")[-1] + ".csv"
