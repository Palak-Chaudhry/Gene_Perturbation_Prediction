...
# ===============================
input_files <- c(
  "../data/active_guides_CRISPRa_mean_pop_mean.csv"
#  "../data/active_guides_CRISPRa_mean_pop_median.csv",
#  "../data/active_guides_CRISPRa_mean_pop_zscore.csv",
#  "../data/active_strong_guides_CRISPRa_mean_pop_mean.csv",
#  "../data/active_strong_guides_CRISPRa_mean_pop_median.csv",
#  "../data/active_strong_guides_CRISPRa_mean_pop_zscore.csv",
#  "../data/active_strong_highexpr_guides_CRISPRa_mean_pop_mean.csv",
#  "../data/active_strong_highexpr_guides_CRISPRa_mean_pop_median.csv",
#  "../data/active_strong_highexpr_guides_CRISPRa_mean_pop_zscore.csv"
)
...
# Optional: Keep old code for reference
# embeddings_new <- np$load("../data/decima_perturbation_embedding/embedding_mean_pooled_mat_d9vqzje4.npy")
# embeddings <- matrix(embeddings_new, nrow = 15587, ncol = 1920 * 3)
# meta_table <- fread("../data/decima_perturbation_embedding/gene_meta_data.tsv", sep="\t")
# rownames(embeddings) <- meta_table$V1
# ===============================
# Loop over datasets
# ===============================
