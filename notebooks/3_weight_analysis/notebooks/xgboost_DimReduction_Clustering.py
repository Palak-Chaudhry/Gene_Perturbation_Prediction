#!/usr/bin/env python
# Converted from xgboost_DimReduction_Clustering.ipynb
...
gencode_path = '../../2_regression/xgboost/results/gencode_feature_importance.csv'
tss_path = '../../2_regression/xgboost/results/tss_feature_importance.csv'
...
plt.tight_layout()
plt.savefig('../figures/xgboost_tss_clustering.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('../figures/xgboost_gencode_clustering.png', dpi=300, bbox_inches='tight')
plt.show()